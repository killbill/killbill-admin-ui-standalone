...
module Kaui
  ...
  self.additional_invoice_links = lambda { |invoice, ctx| ctx) { ctx.link_to 'Addtinal invoice link', ctx.metal_engine.bulk_invoice_adjustment_path(invoice.account_id, invoice.invoice_id), class: 'btn', target: '_self' }
