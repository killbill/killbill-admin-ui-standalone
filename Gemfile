...
gem 'kaui', github: 'killbill/killbill-admin-ui', ref: 'kaui_4.08'
...
# gem 'killbill-aviate', github: 'killbill/killbill-aviate-ui', ref: 'master'
gem 'killbill-aviate', '2.3.0.pre.1'
